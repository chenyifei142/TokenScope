...
<p align="center">
  ...
  <img alt="Version 1.2.0" src="https://img.shields.io/badge/version-1.2.0-2f6fe4">
</p>
...
前往 [GitHub Releases](https://github.com/chenyifei142/TokenScope/releases/tag/v1.2.0) 下载 Windows 便携版：

- `TokenSpider-v1.2.0-windows-x64.exe`
...
已验证的发布环境为 Python 3.12、PyInstaller 6.21、PySide6 6.11。构建产物位于 `dist\TokenSpider-v1.2.0-windows-x64.exe`。spec 仅排除项目未使用的 Qt QML/Quick/PDF/OpenGL/测试组件和非 Windows 平台插件；`build*`、`dist*` 与构建虚拟环境均被 Git 忽略。
