...
<p align="center">
  ...
  <img alt="Version 1.7.5" src="https://img.shields.io/badge/version-1.7.5-2f6fe4">
</p>
...
- 今日分时 Token 图使用分钟级堆叠柱状图，支持全天导航、图例显隐与柱内悬浮明细
...
前往 [GitHub Releases](https://github.com/chenyifei142/TokenSpider/releases/tag/v1.7.5) 下载 Windows 便携版：

- `TokenSpider-v1.7.5-windows-x64.exe`
